...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true, // 是否显示切换主题按钮 true
  ...
  GREETING_WORDS:
    ...
    'Hi,这里是交易员的天地,更是交易员的加油站,Hi,我是一个GDTC-bot,欢迎来到我的Blog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GDTC-bot', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '终日醉心于无尽交易之Bot', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '搞好话你知拉~5好心急!', // 网站地址
